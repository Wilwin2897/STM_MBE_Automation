...
class DragGroup(QtWidgets.QGroupBox):
...
class button_group(QtWidgets.QWidget):
    
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.groupBox = DragGroup(self)
        self.groupBox.setGeometry(QtCore.QRect(30, 40, 211, 151))
