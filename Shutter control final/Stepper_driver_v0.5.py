...
class Worker(QObject):
    ...
    def connect(self):
        ...
        try:
            response = http.request("GET", "http://"+IP+"/command_"+string, timeout=1,retries=False)
...
class Worker3(QObject):
    ...
    def __init__(self, Angle1, Angle2, Angle3, Angle4, delay, wait,max_iter, iterate, parent=None):
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.spinBox_5.setGeometry(QtCore.QRect(250, 630, 51, 31))
        self.spinBox_5.setFont(font)
        self.spinBox_5.setObjectName("spinBox_4")
        self.spinBox_5.setRange(0, 99)
    ...
    def run_process(self):
        ...
        max_iter = self.spinBox_5.value()
        zero_list =[zero_angle,zero_angle,zero_angle,zero_angle]
        Angles = [Angle1,Angle2,Angle3,Angle4]
        
        
        self.thread3 = QThread()
        self.worker3 = Worker3(Angle1, Angle2, Angle3, Angle4,delay,Wait, max_iter,self.checkBox.isChecked())
